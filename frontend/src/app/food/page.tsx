          ...
          <div className="space-y-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 text-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button onClick={() => addWater(250)} disabled={loading} className="py-2 bg-zinc-800 hover:bg-blue-500/20 hover:text-blue-500 border border-zinc-700 rounded transition-colors disabled:opacity-50">+250ml</button>
                <button onClick={() => addWater(500)} disabled={loading} className="py-2 bg-zinc-800 hover:bg-blue-500/20 hover:text-blue-500 border border-zinc-700 rounded transition-colors disabled:opacity-50">+500ml</button>
              </div>
            </div>
          </div>
